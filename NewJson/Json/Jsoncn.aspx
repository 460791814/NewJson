...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="/Js/json/base.css" rel="stylesheet" type="text/css" />
...
<main class="row-fluid">
    ...
    <div class="col-md-7" style="padding:0;">
        ...
        <form id="form-save" action="/main/save.html" method="POST"><input type="hidden" value="" id="txt-content" name="content"></form>
    </div>
    <br style="clear:both;" />
</main> 
 </div>
