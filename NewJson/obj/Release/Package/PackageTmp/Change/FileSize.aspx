<%@ Page Title="在线文件大小换算,转换,换算范围（bit,bytes,KB,MB,GB,TB）" Language="C#" MasterPageFile="~/Main.Master"
    AutoEventWireup="true" CodeBehind="FileSize.aspx.cs" Inherits="NewJson.Change.FileSize" %>
            ...
            <div class="media">
                <div class="media-body">
                    <h2 class="media-heading">
                        在线文件大小换算,转换,换算范围（bit,bytes,KB,MB,GB,TB）</h2>
                </div>
            </div>
        </div>
