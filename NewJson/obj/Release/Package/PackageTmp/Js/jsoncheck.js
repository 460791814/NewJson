        ...
        var a = {
            ...
            parse: function(a) {
                ...
                for (;;) {
                    ...
                    if (s[0] instanceof Array && s.length > 1) throw new Error("\u89e3\u6790\u9519\u8bef: multiple actions possible at state: " + r + ", token: " + p);
                    switch (s[0]) {
                    case 1:
                        c.push(p),
        ...
        f = function() {
            var a = {
                ...
                next: function() {
                    ...
                    this.parseError("\u5728\u7ebf\u9519\u8bef " + (this.yylineno + 1) + ". \u672a\u80fd\u8bc6\u522b\u6587\u672c.\n" + this.showPosition(), {
                        text: "",
                        token: null,
                        line: this.yylineno
                    })
