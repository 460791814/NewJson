...
if(ctype==0)
    document.getElementById("result_input").value = jtgo(document.getElementById("text_input").value); 
else if(ctype==2)
    document.getElementById("result_input").value = qqgo(document.getElementById("text_input").value);
else
    document.getElementById("result_input").value = ftgo(document.getElementById("text_input").value);
} 
