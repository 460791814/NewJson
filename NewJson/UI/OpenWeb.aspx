<%@ Page Title="在线OPEN参数生成器,弹出窗口生成器 " Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="OpenWeb.aspx.cs" Inherits="NewJson.UI.OpenWeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <div class="panel panel-default">
       ...
       <div style=" margin-top:15px" class="validateButtons clear">
           ...
           <input type="button" name="name" class="btn btn-default" onclick="check(this,'selfopen')" value="本窗口打开" />
              <input type="button" name="name" class="btn btn-default" onclick="check(this,'tool')" value="工具栏" />
                  <input type="button" name="name" class="btn btn-default" onclick="check(this,'loc')" value="地址栏" />
                      <input type="button" name="name" class="btn btn-default" onclick="check(this,'stat')" value="状态栏" />    
                      <input type="button" name="name" class="btn btn-default" onclick="check(this,'menu')" value="菜单栏" />
                          <input type="button" name="name" class="btn btn-default" onclick="check(this,'resize')" value="调大小" />
                              <input type="button" name="name" class="btn btn-default" onclick="check(this,'scroll')" value="滚动条" />
       ...
       <div class="input-group"  style="float:left;width: 200px;">
                ...
                <input type="text" class="form-control"  name="T"  style="width: 100px" placeholder="" onkeyup="openAttr(false);" aria-describedby="basic-addon1">
            </div>
            <div class="input-group" style="float:left;width: 200px;">
                <span class="input-group-addon" id="Span2">左边距</span>
                <input type="text" class="form-control" name="L" style="width: 100px" placeholder="" onkeyup="openAttr(false);"  aria-describedby="basic-addon1">
            </div>
                        <div class="input-group" style="float:left;width: 200px;">
                <span class="input-group-addon" id="Span3">宽度</span>
                <input type="text" class="form-control"  name="width" style="width: 100px" placeholder="" onkeyup="openAttr(false);"  aria-describedby="basic-addon1">
            </div>
                        <div class="input-group" style="float:left;width: 200px;">
                <span class="input-group-addon" id="Span4">高度</span>
                <input type="text" class="form-control" name="height" style="width: 100px" placeholder="" onkeyup="openAttr(false);"  aria-describedby="basic-addon1">
            </div>
       </div>
