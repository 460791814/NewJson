<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="NewJson.Tools.WebForm1" %>
...
<script type="text/javascript" src="http://l.tbcdn.cn/apps/top/x/sdk.js?appkey=21494544"></script>
    ...
    <script type="text/javascript" src="/js/tools/qrcode/subnav.js"></script>
        <!--<div class="adrift">
        <a href="/xiazai/" rel="nofollow" target="_blank">联图二维码客户端<img src="picture/app.png" width="90" height="90"/>点击或扫描下载</a>
        </div>-->
        <div class="main">
            <div class="block">
                <div class="left">
