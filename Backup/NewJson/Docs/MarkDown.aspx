<%@ Page Title="Markdown 语法说明(简体中文版)" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MarkDown.aspx.cs" Inherits="NewJson.Docs.MarkDown" %>
...
<h1>Markdown 语法说明 (简体中文版) / (<a href="/docs/markdownbasic/">点击查看快速入门</a>)</h1>
