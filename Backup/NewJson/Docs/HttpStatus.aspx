<%@ Page Title="HTTP状态码详解" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="HttpStatus.aspx.cs" Inherits="NewJson.Docs.HttpStatus" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<meta name="Keywords" content="HTTP状态码详解,常用对照表">
<meta name="Description" content="HTTP状态码详解,常用对照表">
        ...
        <div class="panel-heading">
            <div class="media">
                <div class="media-body">
                    <h4 class="media-heading">HTTP状态码详解</h4>
                </div>
            </div>
        </div>
