...
function format3()
{
 ...
 function chklen() {
  var strlen;
  strlen= document.getElementById("thebody").value.length;
...
function CheckWords() {
    ...
    var rng = document.getElementById("thebody").value;
...
var str = document.getElementById("thebody").value;
...
document.getElementById("thebody").value = k;
}