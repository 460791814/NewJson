...
var jsonCompositeTemplate = '<div id="json-composite"><div id="validator-placeholder1"></div><div id="validator-placeholder2"></div><div id="diff-placeholder"></div></div>',
	validatorTemplate = '<form class="JSONValidate" method="post" action="." name="JSONValidate"><textarea class="json_input" name="json_input" class="json_input" rows="30" cols="100" spellcheck="false" placeholder="请输入需要验证的JSON文本..."></textarea><a href="#" title="验证" class="button validate"><span class="icon">Lint Me!</span></a><a href="#" title="单侧/两侧模式" class="button split-view"><span class="icon">单侧/两侧模式</span></a>	<a href="#" title="删除" class="button reset"><span class="icon">重置</span></a><a href="#" title="验证JSON, 同时运行diff" class="button diff"><span class="icon">Diff</span></a></form>',
	errorTemplate = '<div class="error-view"><a class="close-btn" href="#">X</a><span class="arrow-down"></span><pre class="results"></pre></div>',
	diffTemplate = '<div id="diff-view"><a href="#" title="验证JSON, 同时运行diff" class="button diff"><span class="icon">Diff</span></a><a href="#" title="取消diff" class="button cancel-diff"><span class="icon">取消diff</span></a><div class="json_input" contenteditable="true"></div></div>';
